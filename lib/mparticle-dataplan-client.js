...
// Dataplan TTL set to 5 minutes
const dataplanCache = new NodeCache({stdTTL: 300});
...
module.exports.validate = async (jsonBatch, dataPlanId = '', dataPlanVersion = 1, dataPlanTTL=null) => {
  let jsonResult,
      res;
